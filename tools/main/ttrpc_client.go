...
func main() {
	...
	conn, err := vm.VSockDial(ctx, logger, "/var/lib/firecracker-containerd/shim-base/default#46ce9eea-715a-46c6-9f32-e49f3db82197/firecracker.vsock", _defaultVsockPort)
	if err != nil {
		fmt.Println(err)
		return
	}
